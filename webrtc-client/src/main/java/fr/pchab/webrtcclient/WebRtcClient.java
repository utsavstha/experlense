...
public class WebRtcClient {
    ...
    static ArrayList<Command> peerConnectedlisteners = new ArrayList<>();

    public void addPeerConnectedListener(Command command){
        peerConnectedlisteners.add(command);
    }
    ...
    public class CreateOfferCommand implements Command{
        ...
        public void execute(String peerId, JSONObject payload) throws JSONException {
            ...
            for(Command cmd:peerConnectedlisteners){
                cmd.execute(peerId, payload);
            }
        }
    }
    ...
    public class MessageHandler {
        ...
        public void addCustomCommand(String key, Command command){
